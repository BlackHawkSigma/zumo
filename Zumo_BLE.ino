...
bool accelMode(){
  if (packetbuffer[1] == 'A') {
        ...
        if( y >= 0.1 ){
          ...
          motors.setLeftSpeed( floor( velocity * Lpercent * leftDirection) ); 
          motors.setRightSpeed( floor( velocity * Rpercent * rightDirection) ); 
  ...
  Serial.println(isMoving);
    if (pressed) {
      ...
      lastPress = millis();
        ...
        motors.setSpeeds(leftDirection * speedValue, rightDirection * speedValue);
    } 
